#!/bin/sh
# Compile KG_BoatRace (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
jar cf "$DEST/KG_BoatRace-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KG_BoatRace-$VERSION.jar"
