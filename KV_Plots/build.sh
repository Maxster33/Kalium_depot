#!/bin/sh
# Compile KV_Plots (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
jar cf "$DEST/KV_Plots-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KV_Plots-$VERSION.jar"
