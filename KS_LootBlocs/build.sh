#!/bin/sh
# Compile KS_LootBlocs (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
OUT="$TOOLS/classes/KS_LootBlocs"
...
jar cf "$DEST/KS_LootBlocs-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KS_LootBlocs-$VERSION.jar"
