#!/bin/sh
# Compile KS_Enclume (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
jar cf "$DEST/KS_Enclume-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KS_Enclume-$VERSION.jar"
