#!/bin/sh
# Compile KG_Menu (menu du serveur kal-games) (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
jar cf "$DEST/KG_Menu-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KG_Menu-$VERSION.jar"
