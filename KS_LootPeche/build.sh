#!/bin/sh
# Compile KS_LootPeche (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
OUT="$TOOLS/classes/KS_LootPeche"
...
jar cf "$DEST/KS_LootPeche-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KS_LootPeche-$VERSION.jar"
