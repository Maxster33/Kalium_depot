#!/bin/sh
# Compile KG_Bingo (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
CP="$(win "$TOOLS/classes/KalGames")$SEP"
...
jar cf "$DEST/KG_Bingo-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KG_Bingo-$VERSION.jar"
