#!/bin/sh
# Compile KS_Dimensions (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
# Depend de KLM_Menu : KLM_Menu est compile d abord et ses classes servent seulement a compiler (jamais embarquees).
set -e
...
OUT="$TOOLS/classes/KS_Dimensions"
...
jar cf "$DEST/KS_Dimensions-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KS_Dimensions-$VERSION.jar"
