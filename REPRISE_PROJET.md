...
- **Tester KaliumRelay 1.2.0** (proxy) : `/server` refusé à un joueur, accepté pour LeKiwi06 / Maaxster ; absent de la
  touche Tab pour les joueurs. **Vérifier la boussole du lobby** (destination « Kanvas », après `/kaliummenu reload`).
