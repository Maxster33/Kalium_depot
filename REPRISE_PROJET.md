...
| Kanvas (ex Kal-Test-Dev) | `KaliumCore-1.4.0.jar` + `KLM_Menu-2.0.0.jar` (24/09/2026, rôle `backend` par défaut) ; `KV_Plots-1.1.1.jar` (26/09/2026 02:10 ; anciennes dans `_removed-kv_plots-1.0.0/` et `_removed-kv_plots-1.1.0/`) + `KV_Menu-1.0.0.jar` (26/09/2026 02:02), LeKiwi06 ; FastAsyncWorldEdit **Paper** 2.15.4 (26/09/2026 : la variante Bukkit/Spigot installée d'abord ne fonctionnait pas sur Paper 26.2, rangée dans `_removed-fastasyncworldedit-2.15.4-bukkit/`) (limites `limits.default` réduites le 26/09/2026, original dans `_removed-fastasyncworldedit-config-2026-09-26/`) + WorldGuard 7.0.19 ; monde principal renommé `Kanvas` (`level-name=Kanvas`) | KV_Plots 1.0.0 testé et confirmé par LeKiwi06 le 26/09/2026 ; FAWE Paper testé et confirmé par LeKiwi06 le 26/09/2026 (joueur : seulement dans son plot, sélection à cheval sur la bordure limitée au plot ; permissions LuckPerms du groupe `default` données ; baguette de navigation de WorldEdit passée de la boussole au vide de structure, original dans `_removed-fastasyncworldedit-config-2026-09-26/`) ; KV_Plots 1.1.1 et KV_Menu 1.0.0 non testés ; KaliumCore non testé (projet en pause) |
