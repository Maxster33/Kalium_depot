...
| **Kal-Games** (`kal-games`, hub, machine 7001, ex KalGames2) | copie complète de kal-games du 24/09/2026, puis le 24/09/2026 à 17 h 13 (LeKiwi06) : `KalGames-1.16.0.jar` (remplacé à 19 h 47) + **`KG_Menu-1.0.0.jar` + `KLM_Menu-2.1.0.jar` + `KG_Bingo-1.3.0.jar` (`bingo.server-name: serveur-jeux`) + `KG_ScoreBoards-1.2.0.jar`** (anciens jars et configs dans les `_removed-…` de chaque plugin) + Floodgate, BedrockSkinRestorer, VelocityCommandForward, GrimAC ; 24/09/2026 à 19 h 47 : KalGames 1.17.0 + KG_BoatRace 1.0.0 (la course de bateau sort de KalGames) ; **à 20 h 07 : `KalGames-1.18.0.jar` (éditeur de checkpoints) + `KG_BoatRace-1.1.0.jar` (km/h, seuil 45 s)**, testés par LeKiwi06 | testé et confirmé par LeKiwi06 le 24/09/2026 (menus, boussole, course de bateau, Parkour, classements, Bingo, Java et Bedrock) ; non testé : Rush, capture d'arène |
