#!/bin/sh
# Compile KG_ScoreBoards (classements ; aucune dependance vers un autre plugin) (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
jar cf "$DEST/KG_ScoreBoards-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KG_ScoreBoards-$VERSION.jar"
