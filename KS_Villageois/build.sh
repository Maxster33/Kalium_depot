#!/bin/sh
# Compile KS_Villageois (ECJ, cible Java 21 : tourne sur Java 21+ / 25) et assemble le .jar
...
OUT="$TOOLS/classes/KS_Villageois"
...
jar cf "$DEST/KS_Villageois-$VERSION.jar" -C "$OUT" .
echo "OK -> $DEST/KS_Villageois-$VERSION.jar"
